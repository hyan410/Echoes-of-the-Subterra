...
export const HW2Events = {
    ...
    PLAYER_PROJECTILE_COLLISION: "PLAYER_PROJECTILE_COLLISION",

    SPAWN_PROJECTILE: "SPAWN_PROJECTILE",

    PROJECTILE_SPAWNED: "PROJECTILE_SPAWNED",

    LASER_PROJECTILE_COLLISION: "PROJECTILE_LASER_COLLISION",

    SHOT_ENEMY: "SHOT_ENEMY",

    WEAKTOLIGHT: "SHOT_WEAKTOLIGHT",

    NODE_DESPAWN: "NODE_DESPAWN",

    ENEMY_WEAKENED: "ENEMY_WEAKENED",
